...
<head>
    ...
    <title>Add Event Participation</title>
            ...
            <div class="container mt-3">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <form method="post" action="/BTL/handle/event_participation_process.php?action=add" onsubmit="return validateForm()">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="trang_thai" class="form-select">
                                    <option value="Đã đăng ký" selected>Đã đăng ký</option>
