...
<head>
    ...
    <title>Add Training Score</title>
            ...
            <div class="container mt-3">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <form method="post" action="/BTL/handle/training_score_process.php?action=add" onsubmit="return validateForm()">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="diem" class="form-control" required min="0" max="100" oninput="updateRank()">
                            </div>
                            <div class="mb-3">
