            ...
            <div class="container mt-3">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <form method="post" action="/BTL/handle/account_process.php?action=add">
                            <div class="mb-3">
                                <label class="form-label">Mã thành viên</label>
                                <input type="number" name="doan_vien_id" class="form-control" placeholder="Nhập mã thành viên (tùy chọn)">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="vai_tro" class="form-select" required>
                                    ...
                                    <option value="DoanTruong">Đoàn trưởng</option>
