      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/BTL/views/student/profile.php" aria-expanded="false">
                <span><iconify-icon icon="solar:money-bag-bold-duotone" class="fs-6"></iconify-icon></span>
                <span class="hide-menu">Hồ sơ cá nhân</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="/BTL/views/student/union_fee.php" aria-expanded="false">
                <span><iconify-icon icon="solar:money-bag-bold-duotone" class="fs-6"></iconify-icon></span>
                <span class="hide-menu">Quản lý đoàn phí</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="/BTL/views/student/training_score.php" aria-expanded="false">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/BTL/views/student/events.php" aria-expanded="false">
                <span><iconify-icon icon="solar:calendar-bold-duotone" class="fs-6"></iconify-icon></span>
                <span class="hide-menu">Quản lý sự kiện</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="/BTL/views/student/awards.php" aria-expanded="false">
                <span><iconify-icon icon="solar:medal-star-bold-duotone" class="fs-6"></iconify-icon></span>
                <span class="hide-menu">Khen thưởng và kỷ luật</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="/BTL/views/student/dashboard.php" aria-expanded="false">
