...
<body>
    ...
    <div class="body-wrapper" style="margin-left:260px; padding:20px;">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h3 class="mb-4">THÊM TỔ CHỨC ĐOÀN</h3>
                ...
                <form method="POST" action="../../handle/youth_union_process.php">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="loai" name="loai" required>
                            ...
                            <option value="Liên chi đoàn/Đoàn khoa">Liên chi đoàn/Đoàn khoa</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="cap_tren_id" name="cap_tren_id">
                            ...
                            <?php foreach ($parent_unions as $parent): ?>
                                <option value="<?= $parent['id'] ?>"><?= htmlspecialchars($parent['ten']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary">Thêm tổ chức đoàn</button>
