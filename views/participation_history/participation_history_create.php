...
<head>
    ...
    <title>Thêm lịch sử tham gia</title>
            ...
            <div class="container mt-3">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <form method="post" action="/BTL/handle/participation_history_process.php?action=add" onsubmit="return validateForm()">
                            <div class="mb-3">
