            ...
            <div class="container mt-3">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <form method="post" action="/BTL/handle/union_fee_process.php?action=add" onsubmit="return validateForm()">
                            <div class="mb-3">
                                ...
                                <select name="loai_doan_phi_id" class="form-select" required onchange="updateAmount()">
                                    ...
                                    <?php if (!empty($fee_types)): ?>
                                        <?php foreach ($fee_types as $fee_type): ?>
                                            <option value="<?= htmlspecialchars($fee_type['id'], ENT_QUOTES, 'UTF-8') ?>" data-amount="<?= htmlspecialchars($fee_type['so_tien'], ENT_QUOTES, 'UTF-8') ?>">
                                                <?= htmlspecialchars($fee_type['ten'], ENT_QUOTES, 'UTF-8') ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <option value="">Không có loại đoàn phí nào</option>
                                    <?php endif; ?>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Năm học</label>
                                <input type="text" name="nam_hoc" class="form-control" required placeholder="VD: 2023-2024">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Số tiền</label>
                                <input type="number" name="so_tien" class="form-control" step="0.01" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Ngày nộp</label>
                                <input type="date" name="ngay_nop" class="form-control">
                            </div>
                            <div class="mb-3">
