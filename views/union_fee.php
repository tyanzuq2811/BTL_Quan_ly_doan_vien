...
$offset = ($page - 1) * $limit;
$fees = getAllFees($search, $limit, $offset);
$total_fees = getTotalFees($search);
            ...
            <?php if (!empty($fees)): ?>
                <?php foreach ($fees as $fee): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($fee['so_tien'], ENT_QUOTES, 'UTF-8') ?></td>
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger btn-sm" onclick="showDeleteModal(<?= htmlspecialchars($fee['id'], ENT_QUOTES, 'UTF-8') ?>, '<?= htmlspecialchars($fee['doan_vien_ho_ten'] . ' - ' . $fee['loai_doan_phi_ten'], ENT_QUOTES, 'UTF-8') ?>')">Xóa</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Bạn có chắc muốn xóa đoàn phí <strong id="feeName"></strong>? Hành động này không thể hoàn tác.
                </div>
