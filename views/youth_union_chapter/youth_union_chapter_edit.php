...
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header("Location: ../youth_union_chapter.php?error=Không tìm thấy liên chi đoàn");
    exit;
}

$id = $_GET['id'];
require_once __DIR__ . '/../../handle/youth_union_chapter_process.php';
...
<head>
  ...
  <title>CHỈNH SỬA LIÊN CHI ĐOÀN</title>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="container mt-3">
        <div class="row justify-content-center">
            <div class="col-md-6">
            <h3 class="mt-3 mb-4">CHỈNH SỬA LIÊN CHI ĐOÀN</h3>
    ...
    <form action="../../handle/youth_union_chapter_process.php" method="POST" class="w-50">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="ten" name="ten"
                    value="<?= htmlspecialchars($chapter['ten']); ?>" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="doan_truong_id" name="doan_truong_id"
                    value="<?= htmlspecialchars($chapter['doan_truong_id']); ?>" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="ngay_thanh_lap" name="ngay_thanh_lap"
                    value="<?= htmlspecialchars($chapter['ngay_thanh_lap']); ?>" required>
        </div>

        <div class="mb-3">
            <label for="trang_thai" class="form-label">Trạng thái</label>
            <select class="form-select" id="trang_thai" name="trang_thai" required>
                <option value="Hoạt động" <?= $chapter['trang_thai'] === 'Hoạt động' ? 'selected' : '' ?>>Hoạt động</option>
                <option value="Ngừng hoạt động" <?= $chapter['trang_thai'] === 'Ngừng hoạt động' ? 'selected' : '' ?>>Ngừng hoạt động</option>
            </select>
        </div>
