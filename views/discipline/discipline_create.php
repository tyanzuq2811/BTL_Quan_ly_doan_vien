            ...
            <div class="container mt-3">
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <form method="post" action="/BTL/handle/discipline_process.php?action=add" onsubmit="return validateForm()">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="loai_id" class="form-select" required onchange="updateDescription()">
                                    ...
                                    <?php if (!empty($discipline_types)): ?>
                                        <?php foreach ($discipline_types as $type): ?>
                                            <option value="<?= htmlspecialchars($type['id'], ENT_QUOTES, 'UTF-8') ?>" data-description="<?= htmlspecialchars($type['mo_ta'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
                                                <?= htmlspecialchars($type['ten'], ENT_QUOTES, 'UTF-8') ?>
                                            </option>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                                        <option value="">Không có loại kỷ luật nào</option>
                                    <?php endif; ?>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Mô tả loại kỷ luật</label>
                                <textarea id="loai_mo_ta" class="form-control" rows="3" readonly></textarea>
                            </div>
                            <div class="mb-3">
